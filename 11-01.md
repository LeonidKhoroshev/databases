...
*Можно, выбрав для логистов реляционную СУБД, но делать так не стоит из-за потери качества доставки (неоптимальная загрузка курьеров, выбор маршрута и снижение скорости доставки).*
